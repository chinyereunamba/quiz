...
function Intro() {
  return (
    <section className="p-6 flex flex-col lg:h-[90vh] h-screen items-center justify-center gap-unit-2xl max-w-7xl m-auto">
      <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-bold intro">
